...
export function Footer() {
  return (
    <footer className="border-t bg-card/30">
      <div className="container-pad grid gap-8 py-10 sm:gap-10 sm:py-12 md:grid-cols-3">
      ...
      <div className="border-t">
        <div className="container-pad flex flex-col gap-2 py-6 text-center text-xs text-fg/65 sm:flex-row sm:items-center sm:justify-between sm:text-left">
